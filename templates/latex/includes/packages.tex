...
\usepackage{fontspec}
\setmonofont{Menlo}  % 设置全局等宽字体为 Menlo
...
% 为代码环境单独设置标点样式
\lstset{
    basicstyle=\small\ttfamily,  % 使用默认等宽字体设置
    breaklines=true,
    frame=single,
    numbers=left,
    numberstyle=\tiny,
    ...
    keepspaces=true,
    columns=flexible,
    upquote=true,  % 确保使用英文直引号
    fontadjust=true,  % 确保字体设置生效
    basewidth={0.5em,0.45em}  % 优化字符间距
}
